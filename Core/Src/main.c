...
const osThreadAttr_t Calculate_attributes = { .name = "Calculate", .priority =
		(osPriority_t) osPriorityLow, .stack_size = 128 * 4 };
/* Definitions for LIDAR_TIMER */
osTimerId_t LIDAR_TIMERHandle;
const osTimerAttr_t LIDAR_TIMER_attributes = { .name = "LIDAR_TIMER" };
/* Definitions for METRIC_CHANGE_TIMER */
osTimerId_t METRIC_CHANGE_TIMERHandle;
const osTimerAttr_t METRIC_CHANGE_TIMER_attributes = { .name =
		"METRIC_CHANGE_TIMER" };
/* Definitions for LCD_TIMER */
osTimerId_t LCD_TIMERHandle;
const osTimerAttr_t LCD_TIMER_attributes = { .name = "LCD_TIMER" };
/* USER CODE BEGIN PV */
...
int main(void) {
	...
	LIDAR_TIMERHandle = osTimerNew(LIDAR_TIMER_Callback, osTimerPeriodic, NULL,
			&LIDAR_TIMER_attributes);

	/* creation of METRIC_CHANGE_TIMER */
	METRIC_CHANGE_TIMERHandle = osTimerNew(METRIC_CHANGE_TIMER_Callback,
			osTimerPeriodic, NULL, &METRIC_CHANGE_TIMER_attributes);

	/* creation of LCD_TIMER */
	LCD_TIMERHandle = osTimerNew(LCD_TIMER_Callback, osTimerPeriodic, NULL,
			&LCD_TIMER_attributes);
