...
#define LEFT_MOTOR_2_Pin GPIO_PIN_6
#define LEFT_MOTOR_2_GPIO_Port GPIOE
#define RIGHT_MOTOR_I_Pin GPIO_PIN_13
#define RIGHT_MOTOR_I_GPIO_Port GPIOC
...
#define LIDAR_IN_Pin GPIO_PIN_6
#define LIDAR_IN_GPIO_Port GPIOF
#define LIDAR_OUT_Pin GPIO_PIN_7
#define LIDAR_OUT_GPIO_Port GPIOF
#define QSPI_BK1_IO0_Pin GPIO_PIN_8
#define QSPI_BK1_IO0_GPIO_Port GPIOF
#define QSPI_BK1_IO1_Pin GPIO_PIN_9
#define QSPI_BK1_IO1_GPIO_Port GPIOF
#define LEFT_MOTOR_SPEED_Pin GPIO_PIN_10
#define LEFT_MOTOR_SPEED_GPIO_Port GPIOF
...
#define RIGHT_MOTOR_IA4_GPIO_Port GPIOA
...
#define RIGHT_MOTOR_SPEED_Pin GPIO_PIN_0
#define RIGHT_MOTOR_SPEED_GPIO_Port GPIOB
...
#define LEFT_MOTOR_I_Pin GPIO_PIN_6
#define LEFT_MOTOR_I_GPIO_Port GPIOB
